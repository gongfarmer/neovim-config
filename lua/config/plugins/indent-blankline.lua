...
vim.cmd [[highlight IndentBlanklineIndentOne guifg=#E06C75 gui=nocombine]]
vim.cmd [[highlight IndentBlanklineIndentTwo guifg=#E5C07B gui=nocombine]]
vim.cmd [[highlight IndentBlanklineIndentThree guifg=#98C379 gui=nocombine]]
vim.cmd [[highlight IndentBlanklineIndentFour guifg=#56B6C2 gui=nocombine]]
vim.cmd [[highlight IndentBlanklineIndentFive guifg=#61AFEF gui=nocombine]]
vim.cmd [[highlight IndentBlanklineIndentSix guifg=#C678DD gui=nocombine]]
